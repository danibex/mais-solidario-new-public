...
export default function CardFaculdadeComBolsas(props) {
  return (
    <Link href={props.href} className='text-center w-[290px] h-[310px] bg-white shadow border border-stone-300 flex flex-col items-center rounded-lg hover:bg-stone-100 active:bg-stone-200'>
      ...
      <div className='flex flex-row justify-center items-start w-[258px] h-9'>
        ...
        <p className={`${fonts.ubuntu} text-neutral-900 text-xs text-left`}>{props.recomendacao_porcentagem}% dos estudantes recomendam esta instituição</p>
      </div>
